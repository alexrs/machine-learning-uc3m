...
sea cual sea la posición del resto. Basa su decisión en la información dada
por:\\ \\
\centerline{\texttt{livingGhostPositionDistributions}}
\\ \\que contiene una array de pares del tipo (x,y: probabilidad)
